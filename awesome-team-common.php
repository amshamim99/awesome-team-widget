 ...
 * Plugin URI:  https://shamim.com/awesome-team-widgets
 * Version:     1.0.0
 * Author:      Shamim Ahmed
 * Author URI:  https://shamim.com/
...
final class Elementor_Team_Extension {
	...
	public function widget_styles() {
		...
		wp_enqueue_style('elementor-style-css');
		wp_enqueue_style('elementor-bootstrap-css');
	...
	public function widget_scripts() {
		wp_register_script( 
			'elementor-bootstrap-js',
			plugins_url( 'assets/js/bootstrap.min.js', __FILE__ )
		);
		wp_enqueue_script('elementor-bootstrap-js');
	}
    ...
    public function elementor_team_category () {
	   ...
	   \Elementor\Plugin::$instance->elements_manager->add_category( 
	   	'awesome-team-category',
	   	[
	   		'title' => __( 'Awesome Team Category', 'elementor-team' ),
